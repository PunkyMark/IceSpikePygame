...
def isOverQuit(pos, size):
    newSizeQuit = (size[0] * (22 / 800), size[1] * (25 / 1280))
...
def isOverHomeButton(pos, size):
    newSizeHomeButton = (size[0] * (22 / 800), size[1] * (25 / 1280))
...
def isOverPause(pos, size):
    newSizePause = (size[0] * (682 / 800), size[1] * (25 / 1280))
...
def isOverRestart(pos, size):
    newSizeRestart = (size[0] * (212 / 800), size[1] * (845 / 1280))
...
while not gameExit:
    ...
    if isOverArrowLeft(pos, size) and click[0] == 1 and ball.x > ball.vel + 65:
        ball.x -= ball.vel
        ball.left = True
        ball.right = False
    ...
    if isOverArrowRight(pos, size) and click[0] == 1 and ball.x < 800 - ball.width - ball.vel - 65:
        ball.x += ball.vel
        ball.right = True
        ball.left = False
        ball.still_ball = False
